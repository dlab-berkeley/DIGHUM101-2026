...
Bash is a command-line interpreter and scripting language–a kind of programming language used to interact with operating systems. It's basically a simple script that translates human-typed commands into specific actions for the computer.

Compared to Python, Bash is quite limited in terms of its features. We won't be using it extensively, but if you want to learn more, check out these commands:
...
This resource was pulled from [https://github.com/dlab-berkeley/DIGHUM101-2024](https://github.com/dlab-berkeley/DIGHUM101-2024) and only lightly edited.